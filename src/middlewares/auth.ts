...
const parseUserId = (sub: unknown): number => {
...
const parseRole = (role: unknown): string => {
...
const getAuthContextFromToken = (token: string): AuthContext => {
...
const hydrateUserContext = async (authContext: AuthContext, adminRequired: boolean): Promise<AuthContext> => {
