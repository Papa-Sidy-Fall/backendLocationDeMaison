...
const propertyDescription = (title, location) => `${title} situe a ${location}. Cette annonce propose un cadre de vie confortable, des espaces lumineux et un acces facile aux commodites du quartier.`;
export const properties = propertySeeds.map((seed) => {
...
export const nextVisitRequestId = () => {
    const id = counters.visit;
    counters.visit += 1;
    return id;
};
export const nextContactMessageId = () => {
